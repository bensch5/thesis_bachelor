...
Klasse \code{CG2DApplication}, welche selbst die Swing-Komponente \code{JFrame} erweitert und
...
neues \code{PolygonMesh} erzeugt und in dieser Szene visuell dargestellt. % TODO: auf neue Einstellungsmöglichkeiten eingehen
