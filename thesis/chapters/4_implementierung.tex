...
Die Benutzeroberfläche der Anwendung wird mithilfe des Java GUI-Toolkits Swing implementiert. Spezifisch wird die von Prof. Dr.
Philipp Jenke bereitgestellte \code{CG2DApplication} erweitert, welche selbst die Swing-Komponente \code{JFrame} erweitert und
...
die dieser Anwendung hinzugefügt werden.
