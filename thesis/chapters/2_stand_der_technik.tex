...
Formal kann die Erzeugung eines solchen Fraktals mithilfe eines Lindenmayer-Systems (kurz: L-System) beschrieben werden. Dieses wurde bereits 1968
...
als Kommandos einer Turtle-Grafik interpretiert. Ein Beispiel hierfür wäre die Erzeugung der Koch-Kurve. % TODO: Beispiel visualisieren und erklären
...
% zelluläre Automaten vllt zuerst vorstellen (chronologische Reihenfolge beibehalten)
