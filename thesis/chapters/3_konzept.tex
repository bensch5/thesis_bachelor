...
Haben wir erfolgreich eine Graphgrammatik abgeleitet, können wir diese nun verwenden, um daraus neue Winkelgraphen abzuleiten. Dazu wird zunächst eine
...
gefunden, so enthält diese einige freie Variablen. Somit finden wir statt einer konkreten Lösung immer nur einen Raum an möglichen Lösungen. Durch Festlegen
von beliebigen Werten für die freien Variablen können wir daraus nun konkrete Lösungen für das Gleichungssystem entnehmen. % Abschnitt formaler definieren
