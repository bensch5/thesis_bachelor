...
% Warum ist die Hierarchie nützlich?
% Woraus besteht sie und wie wird sie aufgebaut?
% Ableiten weiterer Graphen idealerweise bis alle zum Input lokal ähnlichen Graphen gefunden wurden
% -> in der Praxis nicht besonders trivial (Verweisen auf Sonderfälle, Wachstum der Hierarchie, etc)
% Ableiten von Regeln sowie Sonderfälle dann in eigenem Kapitel
